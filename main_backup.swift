...
class BrowserTab: ObservableObject, Identifiable, Equatable {
    ...
    func loadStartPage() {
        // Get the path to the logo image - try multiple locations
        let currentPath = FileManager.default.currentDirectoryPath
        var logoPath = ""
        
        // Check for image in Assets.xcassets
        let assetPath = "\(currentPath)/Assets.xcassets/logo.imageset/Tiny-HIRES.png"
        if FileManager.default.fileExists(atPath: assetPath) {
            logoPath = "Assets.xcassets/logo.imageset/Tiny-HIRES.png"
        } else {
            // Fallback to random folder
            let randomPath = "\(currentPath)/random/Tiny-HIRES.png"
            if FileManager.default.fileExists(atPath: randomPath) {
                logoPath = "random/Tiny-HIRES.png"
            }
        }
        ...
        <body>
            <div class="container">
                <img src="\(logoPath)" alt="Tiny Browser">
                <h1>Tiny Browser</h1>
